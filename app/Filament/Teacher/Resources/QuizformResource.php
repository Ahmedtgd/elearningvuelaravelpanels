...
use App\Filament\Teacher\Resources\QuizformResource\Pages;
use App\Filament\Teacher\Resources\QuizformResource\RelationManagers;
...
class QuizformResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewQuizform::route('/{record}'),
